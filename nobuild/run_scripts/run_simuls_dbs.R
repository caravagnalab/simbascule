...
shared_sbs = c("DBS4")
private_sbs = c("DBS1",  # UV light exposure
                "DBS2",  # Tobacco smoking
                "DBS3",  # POLE exonuclease domain mutation, CRC + ESO
                "DBS5",  # platinum chemotherapy
                "DBS6",
                "DBS7",  # MMR deficiency, CRC
                "DBS8",
                "DBS10",  # MMR deficiency, CRC
                "DBS11"  # APOBEC activity
                )
catalogue_sbs = COSMIC_dbs[c(shared_sbs, private_sbs),]
