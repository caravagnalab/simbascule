...
regularizer = args[3]  # one among "noreg", "cosine" or "KL"
inference_type = args[4]  # combination of "flat", "hier", "clust" separated by "_"
if (regularizer == "noreg") {
  reg_weight = 0.
  } else reg_weight = 1.

run_id = args[5]

cat(paste("i =", i, "new_hier =", new_hier, "regularizer =", regularizer, "inference_type =", inference_type, "\n"))
...
# Run model #####
generate_and_run(catalogue = COSMIC_filt_merged,
                 comb_matrix = comb_i,
                 py = py,
